<?php
/**
 * Bizzabo Agenda Widget
 * @version 0.1.3
 * @package Bizzabo
 */

class Bizzabo_Agenda_Widget extends WP_Widget {
	 ...
	 * @since  0.1.0
	 */
	protected $widget_slug = 'bizzabo-widget-agenda';
	 ...
	 * @since  0.1.0
	 */
	protected $widget_name = 'Bizzabo Agenda';
	 ...
	 * @since  0.1.0
	 */
	protected static $shortcode = 'bizzabo-agenda';
	...
	public function __construct() {
		...
		$this->widget_name          = esc_html__( 'Bizzabo Agenda Widget', 'bizzabo-agenda' );
		$this->default_widget_title = esc_html__( 'Bizzabo Agenda Widget', 'bizzabo-agenda' );
		...
		parent::__construct(
			...
			array(
				...
				'description' => esc_html__( 'Display the Bizzabo agenda widget.', 'bizzabo-agenda' ),
			)
		);
	...
	public static function get_widget( $atts ) {
		...
		$widget .= bizzabo()->output->template_unique_name( 'agenda', $atts['unique_name'] );
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'bizzabo-agenda' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'unique_name' ); ?>"><?php _e( 'Unique Name:', 'bizzabo-agenda' ); ?></label>
		...
		<p class="description"><?php esc_html_e( 'Please enter your Unique Name.', 'bizzabo-agenda' ); ?></p>
 ...
 * @return  null
 */
function register_bizzabo_agenda_widget() {
	register_widget( 'Bizzabo_Agenda_Widget' );
}
add_action( 'widgets_init', 'register_bizzabo_agenda_widget' );
